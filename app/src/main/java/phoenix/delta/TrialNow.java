...
public class TrialNow extends ActionBarActivity {
    Button now_btn, pause_btn, resume_btn;
    Session currSession;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_forced_now);
        ...
        now_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                // go to next activity
                Intent playNowAct = new Intent(TrialNow.this,TrialWaitActivity.class);
                playNowAct.putExtra("SESSION", currSession);
                Toast.makeText(TrialNow.this, "*" + responseTime / 1000.0 + " sec* Instant Game Access", Toast.LENGTH_SHORT).show();
        ...
        pause_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(TrialNow.this, "Paused", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        resume_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(TrialNow.this, "Resumed", Toast.LENGTH_SHORT).show();
            }
        });
